...
public:
  ...
  int checkAssociated(const OsiSolverInterface *solver,
    ...
    /** Get the
          ...
          desired.
      */
    virtual inline int getMaximumSolutions() const
    {
    ...
    /** Get the
          ...
          desired.
      */
    virtual inline double getMaximumSeconds() const
    {
    ...
    virtual bool maximumSecondsReached() const;
    ...
    /** Get the
          ...
          desired.
      */
    virtual inline double getCutoffIncrement() const
    {
    ...
    /** Get current cut pass number in this round of cuts.
          (1 is first pass) */
    virtual inline int getCurrentPassNumber() const
    {
    ...
    virtual CbcEventHandler::CbcAction dealWithEventHandler(CbcEventHandler::CbcEvent event,
                                                            double objValue,
    ...
    virtual inline void setNumberHeuristicSolutions(int value)
    {
    ...
    virtual inline CbcModel *heuristicModel() const
    {
    ...
    /// Return handler
    virtual inline CoinMessageHandler *messageHandler() const
    {
        return handler_;
    }
    /// Return messages
