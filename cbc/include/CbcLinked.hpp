...
public:
  ...
  /** This creates from a coinModel object
    ...
    */
  inline OsiSolverLink(CoinModel &modelObject);
  ...
  /// Copy constructor
  inline OsiSolverLink(const OsiSolverLink &);

  /// Assignment operator
  inline OsiSolverLink &operator=(const OsiSolverLink &rhs);

  /// Destructor
  inline virtual ~OsiSolverLink();
