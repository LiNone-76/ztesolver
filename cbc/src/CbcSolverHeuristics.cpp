...
// Crunch down model
static void crunchIt(ClpSimplex *model) {
#ifdef JJF_ZERO
  model->dual();
#else
...
*/
inline OsiClpSolverInterface *fixVubs(CbcModel &model, int skipZero2, int &doAction,
...
inline int doHeuristics(CbcModel *model, int type, CbcParameters &parameters,
